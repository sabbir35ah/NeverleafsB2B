...
const SingleProductGallary = () => {
    ...
    const images = [
        "//neverleafs.nl/cdn/shop/files/ficus-150cm.jpg?crop=center&height=50&v=1757999442&width=50",
        "//neverleafs.nl/cdn/shop/files/Neverleafs_1-9.jpg?crop=center&height=50&v=1757837559&width=50",
        "//neverleafs.nl/cdn/shop/files/Neverleafs_3-9.jpg?crop=center&height=50&v=1757837560&width=50",
        "//neverleafs.nl/cdn/shop/files/Neverleafs_2-9.jpg?crop=center&height=50&v=1757837561&width=50",
        "//neverleafs.nl/cdn/shop/files/ficus-150cm.jpg?crop=center&height=50&v=1757999442&width=50",
        "//neverleafs.nl/cdn/shop/files/Neverleafs_1-9.jpg?crop=center&height=50&v=1757837559&width=50",
        "//neverleafs.nl/cdn/shop/files/Neverleafs_3-9.jpg?crop=center&height=50&v=1757837560&width=50",
        "//neverleafs.nl/cdn/shop/files/Neverleafs_2-9.jpg?crop=center&height=50&v=1757837561&width=50"
    ...
    const product = {
        ...
        inStock: true,
        shortDescription: "Shape your artificial plant into any shape you want.",
    };
            ...
            <div className="common-container">
                <div className="custom-main-product-slider-block">
                    ...
                    <div className="custom-main-product-slider-footer">
                        <div class="small-gallery-slider">
                            <div thumbsslider="" className="swiper mySwiper swiper-initialized swiper-horizontal swiper-free-mode swiper-watch-progress swiper-backface-hidden swiper-thumbs">
                                <div className="swiper-wrapper" id="swiper-wrapper-104380964d53f78fb" aria-live="polite">
                                    <Swiper
                            ...
                            {/* Navigation Buttons - EXACT original structure preserved */}
                            <div
                            ...
                            >
                                <img
                                    src="//neverleafs.nl/cdn/shop/t/36/assets/product-next-logo.svg?v=118710310445575741061762073725"
                                    alt="picture"
                                    width=""
                                    height=""
                                />
                            ...
                            >
                                <img
                                    src="//neverleafs.nl/cdn/shop/t/36/assets/product-prev-logo.svg?v=66159767356331194631762073726"
                                    alt="picture"
                                    width=""
                                    height=""
                                />
                    ...
                    <div className="custom-product-info">
                        ...
                        <div className="custom-product-info-container">
                            <h1 className="custom-product-info-title">
                                {product.title}
                            </h1>
                        </div>
                        {/* PRICE */}
                        ...
                        <div className="quanty-add-cart-container-v2">
                            <div className="product-form__input product-form__quantity">
                                <label className="quantity__label form__label" htmlFor="Quantity-custom">
                                    Quantity
                                    <span className="quantity__rules-cart no-js-hidden hidden">
                                        ...
                                        <span>(<span className="quantity-cart">0</span> in winkelwagen)</span>
                                    </span>
                                </label>
                                <div className="price-per-item__container">
                                    <div className="p-quantity">
                                        <button className="quantity__button no-js-hidden" onClick={handleMinus}>
                                            <span><svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false" class="icon icon-minus" fill="none" viewBox="0 0 10 2">
                                        ...
                                        <button className="quantity__button no-js-hidden" onClick={handlePlus}>
                                ...
                                <div className="quantity__rules caption no-js-hidden" id="Quantity-Rules-custom"></div>
                            </div>

                            <div>
                                <div className="product-form" data-hide-errors="false">
                                    <div className="product-form__error-message-wrapper" role="alert" hidden>
                                        <svg aria-hidden="true" focusable="false" className="icon icon-error" viewBox="0 0 13 13">
                                    ...
                                    <form method="post" className="form" data-type="add-to-cart-form">
                                        ...
                                        <input type="hidden" name="product-id" value="15281110810968" />
                                        <input type="hidden" name="section-id" value="template--26336146948440__custom_main_product_hVrfNH" />
                                    </form>
                                </div>
                            </div>
                        </div>
